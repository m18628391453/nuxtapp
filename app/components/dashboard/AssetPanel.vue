      ...
      <div class="flex flex-col gap-3 -mt-3">
        ...
        <div class="flex items-center justify-between w-full">
          ...
          <div class="flex items-center gap-2 cursor-pointer">
            <svg class="w-8 h-4" viewBox="0 0 32 16" fill="none">
              ...
              <rect x="3" y="3" :width="`${parseInt(energyStorageData.soc.percent)/100 * 21}`" height="10" rx="1" fill="#1ADF8C" />
            </svg>
        ...
        <div class="flex items-center justify-between w-full gap-1">
          ...
          <div class="flex-1 h-2 bg-[#ffffff1f] rounded-full overflow-hidden cursor-pointer">
            <div class="h-full bg-[#1ADF8C] rounded-full shadow-[0_0_6px_rgba(52,211,153,0.6)]" :style="{ width: energyStorageData.health.percent }"></div>
          </div>
