<template>
      ...
      <div v-if="visible" class="fixed inset-0 z-[9999] flex items-center justify-center font-sans">
        ...
        <div class="relative w-[960px] bg-[#032748] border border-[#0327489F] rounded shadow-2xl flex flex-col text-white transform transition-all">
          ...
          <div class="flex items-center gap-8 px-6 py-4">
            <button class="bg-[#32AFFF] text-white px-5 py-1.5 rounded text-sm font-medium">实时遥测</button>
            <div class="flex items-center gap-1 cursor-pointer group">
              <span class="text-gray-400 group-hover:text-gray-200 text-sm">设备告警</span>
              <span class="bg-red-500 text-white text-[10px] w-4 h-4 flex items-center justify-center rounded-full leading-none mt-[-8px]">2</span>
            </div>
            <button class="text-gray-400 hover:text-gray-200 text-sm cursor-pointer">数据明细</button>
          </div>
  ...
  // 遥测静态数据
  const telemetryData = [
    { label: 'AB电压(V)', value: '35.64' },
    { label: '转换效率', value: '125,764' },
    { label: 'BC电压(V)', value: '35.64' },
    { label: '装机容量(kW)', value: '160,574' },
    { label: 'CA电压(V)', value: '35.64' },
    { label: '等效小时数(h)', value: '30' },
    { label: 'A相电压(V)', value: '35.64' },
    { label: '电流离散率', value: '20' },
    { label: 'B相电压(V)', value: '35.64' },
    { label: '输入总功率(kW)', value: '260,5' },
    { label: 'C相电压(V)', value: '35.64' },
    { label: '' },
    { label: 'A相电流(A)', value: '6.28' },
    { label: '' },
    { label: 'B相电流(A)', value: '6.21' },
    { label: '' },
    { label: 'C相电流(A)', value: '6.34', highlight: true },
    { label: '' },
    { label: '有功功率(kW)', value: '6,202', highlight: true },
    { label: '' },
    { label: '无功功率(kVar)', value: '2,642', highlight: true },
    { label: '' },
    { label: '功率因数', value: '0.899' },
    { label: '' },
    { label: '电网频率(Hz)', value: '0' },
    { label: '' },
    { label: '机内温度 (℃)', value: '38' },
    { label: '' },
    { label: '日发电量(kWh)', value: '125,764' },
    { label: '' },
    { label: '额定总功率(kW)', value: '160,574' },
    { label: '' },
    { label: '开机时间(秒)', value: '30' },
    { label: '' },
