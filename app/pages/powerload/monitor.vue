<template>
  <div class="flex flex-col w-full h-screen p-4 box-border overflow-hidden bg-transparent text-white font-sans">
    ...
    <div class="flex gap-2 h-[90px] shrink-0 w-full mb-2">
      ...
      >
        <img src="/image/loadmonitor1.png" alt="系统运行功率" class="w-9 h-9 z-10 -ml-1" />
      ...
      >
        <img src="/image/loadmonitor2.png" alt="日累计用电量" class="w-9 h-9 z-10 -ml-1" />
        <div class="flex flex-col justify-center z-10">
      ...
      >
        <img src="/image/loadmonitor3.png" alt="月累计用电量" class="w-9 h-9 z-10 -ml-1" />
        <div class="flex flex-col justify-center z-10">
      ...
      >
        <img src="/image/loadmonitor4.png" alt="年累计用电量" class="w-9 h-9 z-10 -ml-1" />
        <div class="flex flex-col justify-center z-10">
      ...
      >
        <img src="/image/loadmonitor5.png" alt="额定用电功率" class="w-9 h-9 z-10 -ml-1" />
        <div class="flex flex-col justify-center z-10">
      ...
      <div class="flex-1 flex flex-col h-full bg-transparent" style="border-radius: 2px; background: rgba(255,255,255,0.04);">
        ...
        <div class="flex flex-1 w-full h-full overflow-hidden p-4 gap-10">
          ...
          <div class="w-[37.5%] flex flex-col h-full gap-2 overflow-y-auto custom-scrollbar pr-2">
            ...
            <div class="img-content w-full flex items-center justify-center relative z-10000">
          ...
          <div class="flex-1 flex flex-col w-full h-full gap-4">
            ...
            <div class="flex-1 flex flex-col min-h-0 max-h-[48%]">
              <div class="flex justify-between items-center mb-0">
                <div class="text-[14px] font-bold border-l-[3px] border-[#32AFFF] pl-2 leading-none">运行功率分析</div>
                <div class="flex gap-1">
                  <button v-for="t in timeFilters" :key="'p_'+t" class="monitor-button px-3 py-1 text-[12px] rounded border border-[#2A3B5D] text-[#FFFFFF80] hover:text-[#FFFFFFA0] hover:border-[#32AFFF66] transition-colors bg-transparent cursor-pointer flex items-center gap-1">
                    {{ t }}
            ...
            <div class="flex-1 flex flex-col min-h-0  max-h-[48%] -mt-5">
              <div class="flex justify-between items-center mb-0">
                <div class="text-[14px] font-bold border-l-[3px] border-[#32AFFF] pl-2 leading-none">用电量分析</div>
                <div class="flex gap-1">
                  <button v-for="t in timeFilters" :key="'e_'+t" class="monitor-button px-3 py-1 text-[12px] rounded border border-[#2A3B5D] text-[#FFFFFF80] hover:text-[#FFFFFFA0] hover:border-[#32AFFF66] transition-colors bg-transparent cursor-pointer flex items-center gap-1">
                    {{ t }}
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
